##
## part5.asm - Duplicates A List Recursively
##
#################################
#					 	#
#		text segment		#
...
DuplicateListRecursive:
	...
	jal DuplicateListRecursive
	sw $v0, 0($s2)	# next node address
	move $v0, $s2	# in the last recursive call v0 holds the head
	...
	addi $v0, $0, 0 # empty v0 so that it holds the head after the line jal copyListRecursive
	jr	$ra	# jumps to the line after jal copyListRecursive
